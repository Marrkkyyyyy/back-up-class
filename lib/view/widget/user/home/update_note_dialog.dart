...
class UpdateNoteDialog extends StatelessWidget {
  ...
  final LessonDetailsController controller;
  final String noteID;
  final String title;
          ...
          child: Container(
            ...
            child: Column(
                ...
                children: [
                  ...
                  TextFormField(
                    controller: controller.titleUpdate,
                    validator: (val) {
                      if (val!.isEmpty) {
                  ...
                  TextFormField(
                    controller: controller.descriptionUpdate,
                    maxLines: 6,
                    validator: (val) {
                      if (val!.isEmpty) {
                        return "Enter required field";
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: controller.updateRequest == StatusRequest.loading
                            ? () {}
                            : () {
                                if (controller.titleUpdate.text == title &&
                                    controller.descriptionUpdate.text ==
                                        description) {
                                  Get.back();
                                } else {
                                  controller.validateInputUpdate(noteID);
